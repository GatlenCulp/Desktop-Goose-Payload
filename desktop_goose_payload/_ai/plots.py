"""Command-line plotting utilities for desktop_goose_payload.

Usage:
    $ python -m desktop_goose_payload.plots [--input-path PATH] [--output-path PATH]
"""
...
from desktop_goose_payload.config import FIGURES_DIR, PROCESSED_DATA_DIR
