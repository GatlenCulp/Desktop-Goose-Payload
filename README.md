...
https://gatlenculp.github.io/desktop-goose-payload
...
│   ├── ⚙️ settings.json
│   ├── 📋 tasks.json
│   └── ⚙️ 'desktop-goose-payload.code-workspace'
├── 📁 data
...
└── 🚰 'desktop_goose_payload'  <- Easily publishable source code
...
```<h1 align="center">
  <a href="https://github.com//desktop-goose-payload">
...
<div align="center">
  ...
  <br />
  <br />
  <a href="https://github.com/GatlenCulp/desktop-goose-payload/issues/new?assignees=&labels=bug&template=01_BUG_REPORT.md&title=bug%3A+">Report a Bug</a>
  ·
  <a href="https://github.com/GatlenCulp/desktop-goose-payload/issues/new?assignees=&labels=enhancement&template=02_FEATURE_REQUEST.md&title=feat%3A+">Request a Feature</a>
  .
  <a href="https://github.com//desktop-goose-payload/issues/new?assignees=&labels=question&template=04_SUPPORT_QUESTION.md&title=support%3A+">Ask a Question</a>
</div>
...
[![Pull Requests welcome](https://img.shields.io/badge/PRs-welcome-ff69b4.svg?style=flat-square)](https://github.com/GatlenCulp/desktop-goose-payload/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22)
...
See the [open issues](https://github.com/GatlenCulp/desktop-goose-payload/issues) for a list of proposed features (and known issues).

- [Top Feature Requests](https://github.com/GatlenCulp/desktop-goose-payload/issues?q=label%3Aenhancement+is%3Aopen+sort%3Areactions-%2B1-desc) (Add your votes using the 👍 reaction)
- [Top Bugs](https://github.com/GatlenCulp/desktop-goose-payload/issues?q=is%3Aissue+is%3Aopen+label%3Abug+sort%3Areactions-%2B1-desc) (Add your votes using the 👍 reaction)
- [Newest Bugs](https://github.com/GatlenCulp/desktop-goose-payload/issues?q=is%3Aopen+is%3Aissue+label%3Abug)
...
- [GitHub issues](https://github.com/GatlenCulp/desktop-goose-payload/issues/new?assignees=&labels=question&template=04_SUPPORT_QUESTION.md&title=support%3A+)
- Contact options listed on [this GitHub profile](https://github.com/GatlenCulp)

## Project assistance

If you want to say **thank you** or/and support active development of Desktop-Goose-Payload:

- Add a [GitHub Star](https://github.com/GatlenCulp/desktop-goose-payload) to the project.
- Tweet about the Desktop-Goose-Payload.
- Write interesting articles about the project on [Dev.to](https://dev.to/), [Medium](https://medium.com/) or your personal blog.

Together, we can make Desktop-Goose-Payload **better**!
...
For a full list of all authors and contributors, see [the contributors page](https://github.com/GatlenCulp/desktop-goose-payload/contributors).

## Security

Desktop-Goose-Payload follows good practices of security, but 100% security cannot be assured.
Desktop-Goose-Payload is provided **"as is"** without any **warranty**. Use at your own risk.
